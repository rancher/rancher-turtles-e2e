...
export const vars = {
  ...
  v2provRKE2Version: isRancherManagerVersion('2.12') ? 'v1.33.13+rke2r2' : isRancherManagerVersion('2.13') ? 'v1.34.10+rke2r1' : isRancherManagerVersion('2.14') ? 'v1.35.7+rke2r1' : 'v1.36.3+rke2r1',
